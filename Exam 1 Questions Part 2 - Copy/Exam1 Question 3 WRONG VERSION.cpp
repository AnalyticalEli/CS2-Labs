...
//
//
//	Fighter(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
...
//	//Mage constructor
//
//	Mage(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
...
//	// Cleric Constructor
//
//	Cleric(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
...
//
//
//	Thief(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
...
//
//	characters.push_back(new Fighter( 1, generateStat(), generateStat(), generateStat(), generateStat(), ""));
//
//	characters.push_back(new Fighter(generateStat(), generateStat(), generateStat(), generateStat(), generateStat(), ""));
//
//	Fighter* fighter = new Fighter("", gen)
//
...
//
//
//Fighter::Fighter(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
//				int cCharisma, string cFavWeapon) {   //Base case is Excalibur
//
...
//	//Mage constructor
//
//Mage::Mage(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
//	int cCharisma, string cFavSpell) {      //Base case is Wingardium Leviosa 
//
//
...
//// Cleric Constructor
//
//Cleric::Cleric(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
//	int cCharisma, string cFavDeity) {    //Base(d) deity for both our grades and witty one liners
//
...
//
//
//Thief::Thief(int cLevel, int cStrength, int cDexterity, int cConstitution, int cIntelligence, int cWisdom,
//	int cCharisma, string cFavSkill) {  //Base case is a thief of time. (Clickbait) 
//
