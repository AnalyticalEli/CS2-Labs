//Eli Ahmed
//Lab 4f Map of Students (With emails & ID Numbers)
...
//Hard Coding 6 students (elements) to the map:
	...
	cosStudentMap["4000"] = new StudentID{ "Altair", "Kedish", "NB", 20, "2222312" };  //With ID numbers 
	...
	cosStudentMap["cats.edu"] = new StudentID{ "Funny", "Guy", "N/A", 26, "2334423"};   //With email 
	...
	do {
		...
		cout << "Enter an ID Number or email that you want to see ";
