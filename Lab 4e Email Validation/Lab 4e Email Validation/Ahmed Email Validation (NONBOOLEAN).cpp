////Eli Ahmed
////Lab 4h Email Validation (NO COUT) EFFICIENT.
//
//
//#include<iostream>
//#include<string>
...
//
//	//Because this is email validation, went with it only continues 
...
//
//		//Returning false that the email is valid. (EMAIL IS NOT VALID)
//		throw exception("Email is missing @, please add");
//
//		//Without Cout.
//
//	}
...
//									   //Comparing each and verifying bad ones.
//
