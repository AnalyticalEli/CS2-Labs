...
//
//    ~Node() {
//        cout << "Node containing " << getValue().getFName();
//        cout << " " << getValue().getLName() << " has been destroyed" << endl;
//    }
//
//};
//
...
//    cout << endl << endl;
//
//    cout << "Size of peopleTree: " << peopleTree.getRoot()->countHangingNodes() << endl << endl;
//    cout << "MaxDepth of peopleTree: " << peopleTree.getRoot()->maxDepth() << endl << endl;
//    peopleTree.deleteTree();
//
//    return(0);
//}
//
...
//};
//
//int Node::countHangingNodes(void) { // number of elements
//    int sizeCounter = 1;
//
//    if (left != nullptr) {
//        sizeCounter = sizeCounter + left->countHangingNodes();
//    }
//    if (right != nullptr) {
//        sizeCounter += right->countHangingNodes();
//    }
//
//    return sizeCounter;
//}
//
//int Node::maxDepth(void) { // how deep is the tree
//    int maxD = findDepth(getValue());
//    int temp = findDepth(getValue());
//
//    //getValue().display();
//
//    if (left != nullptr) {
//        temp = 1 + left->maxDepth();
//        if (temp > maxD) {
//            maxD = temp;
//        }
//    }
//    if (right != nullptr) {
//        temp = 1 + right->maxDepth();
//        if (temp > maxD) {
//            maxD = temp;
//        }
//    }
//    //cout << "\nmaxD = " << maxD << " and temp = " << temp << endl;
//    return maxD;
//}
//
